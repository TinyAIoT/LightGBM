...
def fetch_data(data, target, name, flatten=False, seed=12):
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        #
        #     fetch_data(covtype_libsvm[0], covtype_libsvm[1], 'covtype', seed=seed)
        ...
        #     fetch_data(housing.data, housing.target, 'california_housing', seed=seed)
        #
        # ########################
        ...
        #     fetch_data(kin8nm.data, kin8nm.target, 'kin8nm', seed=seed)
        #
        # ########################
        ...
        #     fetch_data(X, y, 'mushroom', True, seed=seed)
        ...
        if not os.path.exists(directory + '/breastcancer.test'):
            ...
            X = X.to_numpy()
            y = y.apply(LabelEncoder().fit_transform).to_numpy()
            fetch_data(X, y, 'breastcancer', True, seed=seed)
        ...
        #     X = X.to_numpy()
        #     y = y.apply(LabelEncoder().fit_transform).to_numpy()
        #     fetch_data(X, y, 'wine', True, seed=seed)
        #
        ...
        #     X = X.to_numpy()
        #     y = y.apply(LabelEncoder().fit_transform).to_numpy()
        #     fetch_data(X, y, 'covtype_multi', True, seed=seed)
